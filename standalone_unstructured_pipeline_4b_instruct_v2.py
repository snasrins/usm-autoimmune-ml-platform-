...
# - "instruct": Qwen3-VL-4B-Instruct (faster, direct extraction) ← PRODUCTION READY
# - "2.5-3b-instruct": Qwen2.5-VL-3B-Instruct (has architecture compatibility issues)
MODEL_VARIANT = "instruct"  # Options: "thinking", "instruct", "2.5-3b-instruct"
...
class Qwen3VLEngine:
    ...
    def __init__(self, model_variant: str = "instruct", optimization_tier: str = "tier1", use_model_ner: bool = False):
        ...
        if model_variant == "thinking":
            ...
            model_display = "Qwen2.5-VL-3B-Instruct (FASTEST - 3B params)"
            self.is_qwen25 = True
        else:
            raise ValueError(f"Invalid model_variant: {model_variant}. Use 'thinking', 'instruct', or '2.5-3b-instruct'")
